...
**Other Languages (Basic Listening, Reading, Speaking & Writing):**
...
* 🔧 **IT Support & Hardware (Intermediate):** Competent in PC assembly, hardware repair, and technical maintenance.
* 🌐 **Networking (Intermediate):** Skilled in network infrastructure, protocols, and system configuration.
* 🎮 **Game Design Logic:** Understanding of systems architecture, level design, and gaming mechanics.
* 🧪 **Experimental Approach:** I prioritize a **trial-and-error** process to deeply understand how systems and code work.
* 🤖 **AI Workflow:** Advanced use of AI tools (Prompt Engineering) as a guide for troubleshooting and optimization.
* 💼 **Office Suites:** Advanced proficiency in both **Google Workspace** and **Microsoft Office**.

---

### ⚡ Soft Skills & Volunteering

* ⚜️ **Volunteering:** Proud member of **Scouts de España - Doramas 104**. Active in community service and social values.
* 👥 **Leadership & Teamwork:** Capable of leading initiatives, assisting colleagues, and fostering a collaborative environment.
* 🧩 **Analytical Thinking:** Strong logical approach to solving complex problems efficiently.
...
* **[Vendetta-Games](https://github.com/CRACKXXXX/Vendetta-Games):** A custom web platform designed for FiveM roleplay servers.

---

### 📊 GitHub Stats
*Note: I'm currently focused on learning and experimenting, so my stats are a reflection of my ongoing growth!*
